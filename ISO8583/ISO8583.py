...
"""
	...
	def setProtocolVersion(self, version):
		self.ts = (version.startswith('ts/'))
		
			#ISO8583 contants
		self._BITS_VALUE_TYPE = {}
		# Every self._BITS_VALUE_TYPE has:
		# self._BITS_VALUE_TYPE[N] = [ X,Y, Z, W,K]
		# N = bitnumber
		...
		self._BITS_VALUE_TYPE[2] = ['2','Primary account number (PAN)','LL',19,'n']
		self._BITS_VALUE_TYPE[3] = ['3','Processing code','N',6,'n']
		self._BITS_VALUE_TYPE[4] = ['4','Transaction amount','N',12,'n']
		self._BITS_VALUE_TYPE[5] = ['5','Amount reconciliation','N',12,'n']
		self._BITS_VALUE_TYPE[6] = ['6','Amount cardholder billing','N',12,'n']
		
		if self.ts:
			self._BITS_VALUE_TYPE[7] = ['7','Date and time transmission','N', 10,'n']
			self._BITS_VALUE_TYPE[8] = ['8','Amount cardholder billing fee','N',8,'n']
		else:
			self._BITS_VALUE_TYPE[7] = ['7','Date and time transmission','N', 16,'n']
			self._BITS_VALUE_TYPE[8] = ['8','Amount cardholder billing fee','N',12,'n']
		
		self._BITS_VALUE_TYPE[9] = ['9','Conversion rate reconciliation','N',8,'n']
		self._BITS_VALUE_TYPE[10] = ['10','Conversion rate cardholder billing','N',8,'n']
		self._BITS_VALUE_TYPE[11] = ['11','Systems trace audit number','N',6,'n']
		self._BITS_VALUE_TYPE[12] = ['12','Date and time local transaction','N',6,'n']
		self._BITS_VALUE_TYPE[13] = ['13','Date effective','N',4,'n']
		self._BITS_VALUE_TYPE[14] = ['14','Date expiration','N',4,'n']
		self._BITS_VALUE_TYPE[15] = ['15','Date settlement','N',3,'n']
		self._BITS_VALUE_TYPE[16] = ['16','Date conversion','N',4,'n']
		self._BITS_VALUE_TYPE[17] = ['17','Date capture','N',6,'n']
		if self.ts:
			self._BITS_VALUE_TYPE[18] = ['18','Merchant category code','N',4,'n']
		else:
            self._BITS_VALUE_TYPE[18] = ['18','Message error indicator','LLL',4,'n']
		self._BITS_VALUE_TYPE[19] = ['19','Country code acquiring institution','N',3,'n']
		self._BITS_VALUE_TYPE[20] = ['20','Country code primary account number (PAN)','N',3,'n']
		self._BITS_VALUE_TYPE[21] = ['21','Transaction life cycle identification data','A',6,'an']
		if self.ts:
			self._BITS_VALUE_TYPE[22] = ['22','Point of service data code','N',3,'n']
		else:
			self._BITS_VALUE_TYPE[22] = ['22','Point of service data code','N',6,'n']
		self._BITS_VALUE_TYPE[23] = ['23','Card sequence number','N',3,'n']
		self._BITS_VALUE_TYPE[24] = ['24','Function code','N',4,'n']
		if self.ts:
			self._BITS_VALUE_TYPE[25] = ['25','Transaction condition','N',2,'n']
		else:
			self._BITS_VALUE_TYPE[25] = ['25','Message reason code','N',4,'n']
		self._BITS_VALUE_TYPE[26] = ['26','Merchant category code','N',6,'n']
		self._BITS_VALUE_TYPE[27] = ['27','Message number','N',6,'n']
		self._BITS_VALUE_TYPE[28] = ['28','Date reconciliation','N',8,'n']
		self._BITS_VALUE_TYPE[29] = ['29','Reconciliation indicator','N',8,'n']
		self._BITS_VALUE_TYPE[30] = ['30','Amounts original','N',12,'n']
		self._BITS_VALUE_TYPE[31] = ['31','Data to print','LL',255,'ans']
		self._BITS_VALUE_TYPE[32] = ['32','Acquiring institution identification code','LL',11,'n']
		self._BITS_VALUE_TYPE[33] = ['33','Forwarding institution identification code','LL',11,'n']
		self._BITS_VALUE_TYPE[34] = ['34','Electronic commerce data','LL',28,'n']
		self._BITS_VALUE_TYPE[35] = ['35','Track 2 data','LL',37,'n']
		self._BITS_VALUE_TYPE[36] = ['36','Track 3 data','LLL',104,'n']
		self._BITS_VALUE_TYPE[37] = ['37','Retrieval reference number','N',12,'an']
		self._BITS_VALUE_TYPE[38] = ['38','Approval code','N',6,'an']
		if self.ts:
			self._BITS_VALUE_TYPE[39] = ['39','Action code','N',2,'an']
		else:
			self._BITS_VALUE_TYPE[39] = ['39','Action code','N',4,'an']
		self._BITS_VALUE_TYPE[40] = ['40','Service code','N',3,'an']
		self._BITS_VALUE_TYPE[41] = ['41','Card acceptor terminal identification','A',8,'ans']
		self._BITS_VALUE_TYPE[42] = ['42','Card acceptor identification code','A',15,'ans']
		self._BITS_VALUE_TYPE[43] = ['43','Card acceptor name/location','A',40,'ans']
		if self.ts:
			self._BITS_VALUE_TYPE[44] = ['44','Additional response data','LL',25,'ans']
		else:
			self._BITS_VALUE_TYPE[44] = ['44','Additional response data','LL',99,'ans']
		self._BITS_VALUE_TYPE[45] = ['45','Track 1 data','LL',76,'an']
		self._BITS_VALUE_TYPE[46] = ['46','System and accepting points setup','LL',255,'ansb']
		self._BITS_VALUE_TYPE[47] = ['47','Additional national data','LL',255,'ans']
		self._BITS_VALUE_TYPE[48] = ['48','Additional private data','LLL',999,'an']
		self._BITS_VALUE_TYPE[49] = ['49','Verification data','N',3,'n']
		self._BITS_VALUE_TYPE[50] = ['50','Currency code, settlement','N',3,'n']
		self._BITS_VALUE_TYPE[51] = ['51','Currency code, cardholder billing','A',3,'a']
		self._BITS_VALUE_TYPE[52] = ['52','Personal identification number (PIN) data','B',16,'b']
		self._BITS_VALUE_TYPE[53] = ['53','Security related control information','N',16,'n']
		self._BITS_VALUE_TYPE[54] = ['54','Amounts additional','LLL',120,'an']
		#if self.ts:
		self._BITS_VALUE_TYPE[55] = ['55','Integrated circuit card (ICC) system related data','LL',255,'b']
		#else:
		#	self._BITS_VALUE_TYPE[55] = ['55','Integrated circuit card (ICC) system related data','LL',255,'b']
		#self._BITS_VALUE_TYPE[55] = ['55','Integrated circuit card (ICC) system related data','LLL',999,'ans']
		self._BITS_VALUE_TYPE[56] = ['56','Original data elements','LLL',999,'ans']
		self._BITS_VALUE_TYPE[57] = ['57','Authorisation life cycle code','LLL',999,'ans']
		self._BITS_VALUE_TYPE[58] = ['58','Reserved - national','LL',255,'ansb']
		if self.ts:
			self._BITS_VALUE_TYPE[59] = ['59','Transport data','LL',255,'b']
		else:
			self._BITS_VALUE_TYPE[59] = ['59','Transport data','LLL',999,'ans']
		self._BITS_VALUE_TYPE[60] = ['60','Reserved for national use','LL',7,'ans']
		self._BITS_VALUE_TYPE[61] = ['61','Reserved for national use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[62] = ['62','Reserved for private use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[63] = ['63','Reserved for private use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[64] = ['64','Message authentication code (MAC) field','B',16,'b']
		self._BITS_VALUE_TYPE[65] = ['65','Bitmap tertiary','B',16,'b']
		self._BITS_VALUE_TYPE[66] = ['66','Settlement code','N',1,'n']
		self._BITS_VALUE_TYPE[67] = ['67','Extended payment data','N',4,'n']
		self._BITS_VALUE_TYPE[68] = ['68','Receiving institution country code','N',3,'n']
		self._BITS_VALUE_TYPE[69] = ['69','Settlement institution county code','N',3,'n']
		self._BITS_VALUE_TYPE[70] = ['70','Network management Information code','N',14,'n']
		self._BITS_VALUE_TYPE[71] = ['71','Download file management','N',4,'n']
		self._BITS_VALUE_TYPE[72] = ['72','Data record','LLL',65535,'ansb']
		self._BITS_VALUE_TYPE[73] = ['73','Date action','N',6,'n']
		self._BITS_VALUE_TYPE[74] = ['74','Credits, number','N',10,'n']
		self._BITS_VALUE_TYPE[75] = ['75','Credits, reversal number','N',10,'n']
		self._BITS_VALUE_TYPE[76] = ['76','Debits, number','N',10,'n']
		self._BITS_VALUE_TYPE[77] = ['77','Debits, reversal number','N',10,'n']
		self._BITS_VALUE_TYPE[78] = ['78','Transfer number','N',10,'n']
		self._BITS_VALUE_TYPE[79] = ['79','Transfer, reversal number','N',10,'n']
		self._BITS_VALUE_TYPE[80] = ['80','Inquiries number','N',10,'n']
		self._BITS_VALUE_TYPE[81] = ['81','Authorizations, number','N',10,'n']
		self._BITS_VALUE_TYPE[82] = ['82','Credits, processing fee amount','N',12,'n']
		self._BITS_VALUE_TYPE[83] = ['83','Credits, transaction fee amount','N',12,'n']
		self._BITS_VALUE_TYPE[84] = ['84','Debits, processing fee amount','N',12,'n']
		self._BITS_VALUE_TYPE[85] = ['85','Debits, transaction fee amount','N',12,'n']
		self._BITS_VALUE_TYPE[86] = ['86','Credits, amount','N',16,'n']
		self._BITS_VALUE_TYPE[87] = ['87','Credits, reversal amount','N',16,'n']
		self._BITS_VALUE_TYPE[88] = ['88','Debits, amount','N',16,'n']
		self._BITS_VALUE_TYPE[89] = ['89','Debits, reversal amount','N',16,'n']
		...
		self._BITS_VALUE_TYPE[99] = ['99','Settlement institution identification code','LL',11,'n']
		self._BITS_VALUE_TYPE[100] = ['100','Receiving institution identification code','LL',11,'n']
		self._BITS_VALUE_TYPE[101] = ['101','File name','ANS',17,'ans']
		self._BITS_VALUE_TYPE[102] = ['102','Account identification 1','LL',28,'ans']
		self._BITS_VALUE_TYPE[103] = ['103','Account identification 2','LL',28,'ans']
		self._BITS_VALUE_TYPE[104] = ['104','Transaction description','LLL',100,'ans']
		self._BITS_VALUE_TYPE[105] = ['105','Reserved for ISO use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[106] = ['106','Reserved for ISO use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[107] = ['107','Reserved for ISO use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[108] = ['108','Reserved for ISO use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[109] = ['109','Reserved for ISO use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[110] = ['110','Reserved for ISO use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[111] = ['111','Reserved for private use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[112] = ['112','Reserved for private use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[113] = ['113','Reserved for private use','LL',11,'n']
		self._BITS_VALUE_TYPE[114] = ['114','Reserved for national use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[115] = ['115','Reserved for national use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[116] = ['116','Reserved for national use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[117] = ['117','Reserved for national use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[118] = ['118','Reserved for national use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[119] = ['119','Reserved for national use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[120] = ['120','Reserved for private use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[121] = ['121','Reserved for private use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[122] = ['122','Reserved for national use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[123] = ['123','Reserved for private use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[124] = ['124','Info Text','LLL',255,'ans']
		self._BITS_VALUE_TYPE[125] = ['125','Network management information','LL',50,'ans']
		self._BITS_VALUE_TYPE[126] = ['126','Issuer trace id','LL',6,'ans']
		self._BITS_VALUE_TYPE[127] = ['127','Reserved for private use','LLL',999,'ans']
		self._BITS_VALUE_TYPE[128] = ['128','Message authentication code (MAC) field','B',16,'b']
	
	
	################################################################################################
	#Default constructor of the ISO8583 Object
	def __init__(self,iso="", protocolVersion='default', debug=False):
	...
	def __getBitFromStr(self,strWithoutMtiBitmap):
		...
		for cont in range(2,129):
			...
			# Florent: This code is WRONG and badly written. It is complex and crashes.
			# I'm better off rewriting it completely.
			# NOTE: It relies on the current understanding of data, everything is stored as a big hex string
			
			if self.BITMAP_VALUES[cont] != self._BIT_DEFAULT_VALUE:
				bitType = self.getBitType(cont) 
				bitValueType = self.getBitValueType(cont)
				
				if bitType == 'LL': # Variable size (1 byte header)
					valueSize = int(strWithoutMtiBitmap[offset:offset +2],16)
					offset += 2		
				elif bitType == 'LLL': # Variable size (2 bytes header)
					valueSize = int(strWithoutMtiBitmap[offset:offset +4],16)
					offset += 4;
				else: # It's a fixed value: A and N types make no sense because LL:n is totally different than LL:a
					valueSize = self.getBitLimit(cont)
				
				# We check that we don't go over limit
				if valueSize > self.getBitLimit(cont):
					print("WARNING: Bit {bit} is larger ({size}) than the specification ({specSize}) !".format(bit=cont, size=valueSize, specSize=self.getBitLimit(cont)))
					for cont in range(2,129):
						if self.BITMAP_VALUES[cont] != self._BIT_DEFAULT_VALUE:
							print("Defined bit: {bit}".format(bit=cont))
				
				# Then we need to treat numerical as each char being a number (each number being encoded on 4 bits)
				if bitValueType == 'n':
					# (We must consider the left padding)
					if valueSize%2 != 0:
						valueSize += 1
					length = valueSize
				else:
				...
				value = strWithoutMtiBitmap[offset:offset+length]
				
				if 'a' in bitValueType and not 'b' in bitValueType:
